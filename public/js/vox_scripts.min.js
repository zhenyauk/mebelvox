...
jQuery(document).ready(function(e){e(window).width();e.fn.scrollTo=function(t,i,n){"function"==typeof i&&2==arguments.length&&(n=i,i=t);var o=e.extend({scrollTarget:t,offsetTop:50,duration:200,easing:"swing"},i);return this.each(function(){var t=e(this),i="number"==typeof o.scrollTarget?o.scrollTarget:e(o.scrollTarget),a="number"==typeof i?i:i.offset().top+t.scrollTop()-parseInt(o.offsetTop);t.animate({scrollTop:a},parseInt(o.duration),o.easing,function(){"function"==typeof n&&n.call(this)})})},e(".mash-menu").mashableMenu({separator:!1,ripple_effect:!1,search_bar_hide:!0,top_fixed:!1,full_width:!1,right_to_left:!1,trigger:"hover",vertical_tabs_trigger:"click",vertical_tabs_effect_speed:400,drop_down_effect_in_speed:200,drop_down_effect_out_speed:200,drop_down_effect_in_delay:200,drop_down_effect_out_delay:200,outside_close_dropDown:!0,sticky_header:!1,sticky_header_height:200,sticky_header_animation_speed:400,timer_on:!1,timer_morning_color:"cyan",timer_afternoon_color:"red",timer_evening_color:"teal",internal_links_enable:!0,internal_links_toggle_drop_down:!1,internal_links_target_speed:400,mobile_search_bar_hide:!1,mobile_sticky_header:!1,mobile_sticky_header_height:100,media_query_max_width:1023}),e(".mash-list-items").click(function(t){function i(t){e(t).bind("click",function(t){i.preventDefault(),e(this).parent().fadeOut()})}var i=e(t.target);if(!i.parents().hasClass("mash-list-items")){var n=e(".mash-menu").find(".mash-list-items"),o=n.parent();o.removeClass("normal"),n.hide(0)}}),e(".searchicon").click(function(t){var i=e(window).width();if(i<1024){var n=e(".mash-menu").find(".mash-list-items");n.fadeOut()}e(".dropdown-cart").is(":visible")&&e(".dropdown-cart").fadeToggle(),e(".searchbox").slideToggle("fast",function(){e("#search").focus()}),t.preventDefault()}),e(".mash-mobile-button").submit(function(){e(".searchbox").slideToggle("fast")}),e(function(){e(".search-autocomplete").each(function(){var t=e(this).closest(".autocompletebox"),i=e(this).data("source");e(this).devbridgeAutocomplete({serviceUrl:i,groupBy:"type",paramName:"s",noCache:!0,minChars:3,deferRequestBy:50,appendTo:t,triggerSelectOnValidInput:!1,onSelect:function(e){e.data.url&&(window.location=e.data.url)}}).keydown(function(t){if(13==t.keyCode&&e(this).data("target")&&e(this).val().length>2)return window.location=e(this).data("target")+"?s="+e(this).val(),t.preventDefault(),!1})})}),e(function(){var t=e(".cat-list-container-custom"),i=t.find(".cat-list-menu-custom"),n=t.find(".cat-list-highlight-custom"),o=function(e){if(i.length>0){var t=e.position(),o=i.position(),a=parseInt(i.css("margin-top").replace("px",""));menuMarginLeft=parseInt(i.css("margin-left").replace("px","")),n.css({left:t.left+o.left+menuMarginLeft,top:t.top+o.top+a,width:e.outerWidth(),height:e.outerHeight()})}},a=function(t){t.preventDefault();var i=e(this);o(i)},r=function(){i.length>0&&o(i.find(".active"))};t.length&&i.length&&n.length&&(i.on("click","li a",a),o(i.find(".active")),e(window).on("resize",r),setTimeout(function(){o(i.find(".active"))},500),setTimeout(function(){o(i.find(".active"))},750))})});