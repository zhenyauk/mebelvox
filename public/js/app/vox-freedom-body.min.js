...
$(function(){var t=52.406374,e=16.925168,o=Cookies.get("location-browser"),n=$("base").attr("href");navigator.geolocation&&!o&&(navigator.userAgent.toLowerCase().indexOf("firefox")>-1&&(document.cookie="location-browser=1; path=/"),navigator.geolocation.getCurrentPosition(function(o){if(t=parseFloat(o.coords.latitude),NaN!=(e=parseFloat(o.coords.longitude))&&NaN!=t){document.cookie="location-lat="+t+"; path=/",document.cookie="location-len="+e+"; path=/",a.loadList();Cookies.get("location-browser")||($(".shopsXhr").each(function(){var t=$(this).data("vendor"),e=$(this).data("type"),o=$(this).data("src");$(this).load(o+"?vendor="+t+"&type="+e+"&limit=3",function(t){console.log("shops-loaded")})}),document.cookie="location-browser=1; path=/")}}));var a=function(o){function a(t){google.maps.OverlayView.call(this),this.latlng_=t.latlng,this.map_=t.map,this.offsetVertical_=64-t.contentHeight-330,this.offsetHorizontal_=-180,this.height_=300,this.width_=320,this.content_=t.content;var e=this;this.boundsChangedListener_=google.maps.event.addListener(this.map_,"bounds_changed",function(){return e.panMap.apply(e)}),this.setMap(this.map_)}var s,l,r=o("#shops-map"),p=o("#gmap-wrapper"),d=t,c=e,h=(new google.maps.LatLng(d,c),9),g=1,m=new google.maps.DirectionsService,u=new google.maps.DirectionsRenderer,f={},v=new google.maps.MarkerImage("/assets/img/gmap-icon.png",new google.maps.Size(20,21),new google.maps.Point(0,0),new google.maps.Point(-20,0)),y=document.createElement("div");y.className="setroute";var w=document.createElement("form"),C=document.createElement("form");C.innerHTML='<label for="route" class="form-label control-label">wyznacz<br> trasę</label>',w.appendChild(C);var b=document.createElement("div");b.className="form-input";var _=document.createElement("input");_.id="route",_.type="text",_.className="form-control",_.placeholder="wpisz lokalizację",b.appendChild(_);var k=document.createElement("a");k.id="search-btn",k.type="submit",k.innerHTML="ok",k.className="btn btn-black inputbtn",b.appendChild(k),w.appendChild(b),y.appendChild(w),o(_).on("click",function(){this.focus()}),a.prototype=new google.maps.OverlayView,a.prototype.remove=function(){this.div_&&this.div_.parentNode&&this.div_.parentNode.removeChild(this.div_),this.setMap(null)},a.prototype.draw=function(){if(this.createElement(),this.div_){var t=this.getProjection().fromLatLngToDivPixel(this.latlng_);t&&(this.div_.style.width=this.width_+"px",this.div_.style.left=t.x+this.offsetHorizontal_+"px",this.div_.style.height=this.height_+"px",this.div_.style.top=t.y+this.offsetVertical_+"px",this.div_.style.display="block")}},a.prototype.createElement=function(){var t=this.getPanes(),e=this.div_;if(e)e.parentNode!=t.floatPane&&(e.parentNode.removeChild(e),t.floatPane.appendChild(e));else{e=this.div_=document.createElement("div"),e.style.border="0px none",e.style.position="absolute",e.style.background="transparent",e.style.width=this.width_+"px",e.style.height=this.height_+"px";var o=document.createElement("div");o.className="mapbox",o.style.padding="30px",o.innerHTML=this.content_,o.appendChild(y);var n=document.createElement("div");n.style.position="absolute",n.style.right="7px",n.style.top="5px";var a=document.createElement("img");a.style.width="11px",a.style.height="11pxx",a.style.cursor="pointer",a.src="/assets/img/cross2.svg",n.appendChild(a),google.maps.event.addDomListener(a,"click",function(t){return function(){t.remove()}}(this)),e.appendChild(n),e.appendChild(o),e.style.display="none",t.floatPane.appendChild(e),this.panMap()}},a.prototype.panMap=function(){var t=this.map_,e=t.getBounds();if(e){var o=this.latlng_,n=this.width_,a=this.height_,i=this.offsetHorizontal_,s=this.offsetVertical_,l=t.getDiv(),r=l.offsetWidth,p=l.offsetHeight,d=e.toSpan(),c=d.lng(),h=d.lat(),g=c/r,m=h/p,u=e.getSouthWest().lng(),f=e.getNorthEast().lng(),v=e.getNorthEast().lat(),y=e.getSouthWest().lat(),w=o.lng()+(i-40)*g,C=o.lng()+(i+n+40)*g,b=o.lat()-(s-40)*m,_=o.lat()-(s+a+40)*m,k=(w<u?u-w:0)+(C>f?f-C:0),x=(b>v?v-b:0)+(_<y?y-_:0),L=t.getCenter(),T=L.lng()-k,M=L.lat()-x;t.setCenter(new google.maps.LatLng(M,T)),google.maps.event.removeListener(this.boundsChangedListener_),this.boundsChangedListener_=null}};var x=function(){return!!r.length&&(console.log("map.init"),"undefined"!=typeof google&&google&&p.size()?(google.maps.event.addDomListener(window,"load",L()),void o(".show-on-map").on("click",function(t){return t.preventDefault(),window.history.pushState({},"",o(this).attr("href")),!1})):(o.error("googleMap error"),!1))},L=function(){""!=window.location.hash&&(h=11);var t={center:new google.maps.LatLng(d,c),backgroundColor:"#FFFFFF",zoom:h,mapTypeId:google.maps.MapTypeId.ROADMAP,mapTypeControl:!0,mapTypeControlOptions:{position:google.maps.ControlPosition.TOP_RIGHT},panControl:!1,zoomControl:!0,zoomControlOptions:{position:google.maps.ControlPosition.RIGHT_TOP,style:google.maps.ZoomControlStyle.LARGE},overviewMapControl:!1,rotateControl:!1,scaleControl:!1,streetViewControl:!1};s=new google.maps.Map(p.get(0),t),u.setMap(s);new google.maps.LatLngBounds(new google.maps.LatLng(52.406374,16.925168),new google.maps.LatLng(52.406374,16.925168));N(!0),google.maps.event.addListener(s,"zoom_changed",function(){var t;t=g,g=s.getZoom()>=11?1:2,t!==g&&o.each(f,function(t,e){2==g?e.setIcon(v):e.setIcon(e.imgType)})})},T=function(){var t=window.location.hash.substr(1);if(!t)return!1;setTimeout(function(){google.maps.event.trigger(f[t],"click")},100)},M=function(){var t={map:s,icon:v};o("#map-shops-list ul > li.salonblock:not(.no-result)").each(function(e,n){var i=o(n).data("id"),r=o(n).data("lat"),p=o(n).data("lng"),d=o(n).data("icon"),c=o(".mapbox",n).html(),h=o(".mapbox > .adressmap",n).height(),g=v;if(d){var m="map_sign_"+d+".png";g=new google.maps.MarkerImage("/assets/img/"+m,new google.maps.Size(120,21),new google.maps.Point(0,0),new google.maps.Point(-20,0))}var u=o.extend({},t,{position:new google.maps.LatLng(r,p),icon:s.getZoom()>=11?g:v});f[i]=new google.maps.Marker(u),f[i].imgType=g,google.maps.event.addListener(f[i],"click",function(){$this=this,l&&l.remove(),l=new a({latlng:$this.getPosition(),map:s,content:c,contentHeight:h}),s.setZoom(12),s.panTo(f[i].position),o(k).off("click"),o(k).on("click",function(){P(_.value,$this.getPosition())}),o(w).off("submit"),o(w).on("submit",function(){return P(_.value,$this.getPosition()),!1})})})},P=function(t,e){var n={origin:t,destination:e,optimizeWaypoints:!0,travelMode:google.maps.DirectionsTravelMode.DRIVING};m.route(n,function(t,e){if(e==google.maps.DirectionsStatus.OK){u.setDirections(t);var n=t.routes[0];n.legs[0].distance.value>0&&o(".gmap-infowindow p.distance").html("odległość: "+n.legs[0].distance.text)}})},E=function(){l&&l.remove();var t=!1;o("#map-shops-list ul > li.salonblock:not(.no-result)").each(function(){id=o(this).data("id"),o(this).hasClass("hidden")?f[id].setMap(null):(t||(t=f[id]),f[id].setMap(s))}),t&&s.panTo(t.position)},N=function(t){o("#shops-map #selectCity").val();o("#map-shops-list #map-shops-list-index").load(n+"/salony/ajax-list",function(t){M(),T(),E(),i.init(),o(".salonylist .salonblock").click(function(){o(this).children(".salonmoreinfo").slideToggle("normal",function(){o(this).prev(".arrdown").hasClass("open")?o(this).prev(".arrdown").removeClass("open"):o(this).prev(".arrdown").addClass("open")})})})};return{init:x,refresh:E,setInfoBoxShop:T,loadList:N}}(jQuery),i=function(t){var e=t("#shops-map > .listasalonow"),o=t("#shops-map #selectcountry"),i=t("#shops-map #selectCity"),s=t('#shops-map input[name="schopType[]"]');t(".salonblock > h4",e).on("click",function(e){if(t(this).hasClass("on"))return!1;t(".salonblock > h4").removeClass("on"),t(this).addClass("on"),window.location.hash=t(this).data("hash"),a.setInfoBoxShop()});var l,r=function(t){o.val()&&t.data("country")!=o.val()&&t.addClass("hidden")},p=function(t){if(!i.val()||i.val().length<3)return!1;var e=new RegExp("^"+i.val(),"i");i.val()&&0==e.test(t.data("city"))&&t.addClass("hidden")},d=function(e){if(0==t('#shops-map input[name="schopType[]"]:checked').length)return!1;var o=!1;t('#shops-map input[name="schopType[]"]:checked').each(function(){if(1==new RegExp(t(this).val(),"i").test(e.data("type")))return o=!0,!0}),o||e.addClass("hidden")},c=function(e,o){var n=e.split(","),a=o.split(",");t(".salonylist li.salonblock:not(.hidden, .no-result)").each(function(){var e=t(this),o=e.data("id").split("_")[1];console.log(e.data("id"),t.inArray(o,a)),e.hasClass("meble")&&-1!=t.inArray(o,n)||e.hasClass("dip")&&-1!=t.inArray(o,a)?(e.removeClass("hidden"),console.log(e.data("id"))):e.addClass("hidden")})},h=function(){t(".salonylist li.salonblock:not(.no-result)").removeClass("hidden"),t(".salonylist li.salonblock:not(.hidden, .no-result)").each(function(){var e=t(this);r(e),p(e),d(e)}),g()},g=function(){t(".salonylist li.salonblock:not(.hidden, .no-result)").length?(t(".salonylist li.salonblock.no-result").hide(),a.refresh()):t(".salonylist li.salonblock.no-result").show()};return{init:function(){if(e.length<=0)return!1;if(t('form[name="search-shop"]').submit(function(t){return i.val()&&(window.location.href=n+"/salony?selectcity="+i.val()),!1}),t('form[name="main-search-shop"]').submit(function(t){return history.pushState({},"",n+"/salony?selectcity="+i.val()),t.preventDefault(),!1}),o.on("change",function(){i.val(""),h()}),i.on("change keyup paste",function(){clearTimeout(l),l=setTimeout(function(){h()},600)}),s.on("change",function(){h()}),t("#map-shops-list-index").data("selected-sm")||t("#map-shops-list-index").data("selected-sd")){var a=t("#map-shops-list-index").data("selected-sm")+"",r=t("#map-shops-list-index").data("selected-sd")+"";t("#map-shops-list-index").removeAttr("data-selected-sm"),t("#map-shops-list-index").removeAttr("data-selected-sd"),c(a,r),g()}else h()}}}(jQuery);a.init()});
!function(o){o.pgwModal=function(n){var t={},e={mainClassName:"pgwModal",backdropClassName:"pgwModalBackdrop",maxWidth:500,titleBar:!0,closable:!0,closeOnEscape:!0,closeOnBackgroundClick:!0,closeContent:'<span class="pm-icon"></span>',loadingContent:"Loading in progress...",errorContent:"An error has occured. Please try again in a few moments."};if(void 0!==window.pgwModalObject&&(t=window.pgwModalObject),"object"==typeof n&&!n.pushContent){if(!n.url&&!n.target&&!n.content)throw new Error('PgwModal - There is no content to display, please provide a config parameter : "url", "target" or "content"');t.config={},t.config=o.extend({},e,n),window.pgwModalObject=t}var a=function(){return o("body").append('<div id="pgwModalBackdrop"></div><div id="pgwModal"><div class="pm-container"><div class="pm-body"><span class="pm-close"></span><div class="pm-title"></div><div class="pm-content"></div></div></div></div>'),o(document).trigger("PgwModal::Create"),!0},i=function(){return o("#pgwModal .pm-title, #pgwModal .pm-content").html(""),o("#pgwModal .pm-close").html("").unbind("click"),!0},d=function(){return angular.element("body").injector().invoke(function(o){var n=angular.element($("#pgwModal .pm-content")).scope();o($("#pgwModal .pm-content"))(n),n.$digest()}),!0},c=function(n){return o("#pgwModal .pm-content").html(n),t.config.angular&&d(),l(),o(document).trigger("PgwModal::PushContent"),!0},l=function(){o("#pgwModal, #pgwModalBackdrop").show();var n=o(window).height(),t=o("#pgwModal .pm-body").height(),e=Math.round((n-t)/3);return e<=0&&(e=0),o("#pgwModal .pm-body").css("margin-top",e),!0},r=function(){var n=o('<div style="width:50px;height:50px;overflow:auto"><div></div></div>').appendTo("body"),t=n.children();if("function"!=typeof t.innerWidth)return 0;var e=t.innerWidth()-t.height(90).innerWidth();return n.remove(),e},g=function(){o("#pgwModal, #pgwModalBackdrop").removeClass().hide(),o("body").css("padding-right","").removeClass("pgwModalOpen"),i(),o(window).unbind("resize.PgwModal"),o(document).unbind("keyup.PgwModal"),o("#pgwModal").unbind("click.PgwModalBackdrop");try{delete window.pgwModalObject}catch(o){window.pgwModalObject=void 0}return o(document).trigger("PgwModal::Close"),!0};return"string"==typeof n&&"close"==n?g():"string"==typeof n&&"reposition"==n?l():"string"==typeof n&&"getData"==n?function(){return t.config.modalData}():"string"==typeof n&&"isOpen"==n?function(){return o("body").hasClass("pgwModalOpen")}():"object"==typeof n&&n.pushContent?c(n.pushContent):"object"==typeof n?function(){if(0==o("#pgwModal").length?a():i(),o("#pgwModal").removeClass().addClass(t.config.mainClassName),o("#pgwModalBackdrop").removeClass().addClass(t.config.backdropClassName),t.config.closable?o("#pgwModal .pm-close").html(t.config.closeContent).click(function(){g()}).show():o("#pgwModal .pm-close").html("").unbind("click").hide(),t.config.titleBar?o("#pgwModal .pm-title").show():o("#pgwModal .pm-title").hide(),t.config.title&&o("#pgwModal .pm-title").text(t.config.title),t.config.maxWidth&&o("#pgwModal .pm-body").css("max-width",t.config.maxWidth),t.config.url){t.config.loadingContent&&o("#pgwModal .pm-content").html(t.config.loadingContent);var e={url:n.url,success:function(o){c(o)},error:function(){o("#pgwModal .pm-content").html(t.config.errorContent)}};t.config.ajaxOptions&&(e=o.extend({},e,t.config.ajaxOptions)),o.ajax(e)}else t.config.target?c(o(t.config.target).html()):t.config.content&&c(t.config.content);t.config.closeOnEscape&&t.config.closable&&o(document).bind("keyup.PgwModal",function(o){27==o.keyCode&&g()}),t.config.closeOnBackgroundClick&&t.config.closable&&o("#pgwModal").bind("click.PgwModalBackdrop",function(n){var t=o(n.target).hasClass("pm-container"),e=o(n.target).attr("id");(t||"pgwModal"==e)&&g()}),o("body").addClass("pgwModalOpen");var d=r();return d>0&&o("body").css("padding-right",d),o(window).bind("resize.PgwModal",function(){l()}),o(document).trigger("PgwModal::Open"),!0}():void 0}}(window.Zepto||window.jQuery);
!function(t){"use strict";var a={REQUIRED:"To pole jest wymagane",EMAIL:"Nieprawidłowy adres e-mail",PHONE:"Nieprawidłowy format numeru",POSTCODE:"Nieprawidłowy kod pocztowy",USERNAME:"Nazwa użytkownika musi mieć conajmniej 6 znaków",PASSWORD:"Hasło musi mieć conajmniej 8 znaków",PASSWORDREPEAT:"Podane hasła różnią się"},e={INPUT:"INPUT",SELECT:"SELECT",TEXTAREA:"TEXTAREA"},r={FEEDBACK:"valid-error",GROUP:"form-group",ERROR:"has-error",VALID:"valid-success",INVALID:"valid-error"},n={ERROR:'<span class="%CLASS%">%ERROR%</span>'},i={VALID:"valid-submit",INVALID:"invalid-submit"},o=function(t){return"."+t},s={required:function(t,r){if(r===e.INPUT){if("checkbox"===t.attr("type")&&!t.prop("checked"))throw a.REQUIRED;if(""===t.val())throw a.REQUIRED}else{if(r===e.TEXTAREA&&""===t.val()||null===t.val())throw a.REQUIRED;if(r===e.SELECT&&""===t.val()||null===t.val())throw a.REQUIRED}return!0},email:function(t,e){if(/^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/.test(t.val()))return!0;throw a.EMAIL},phone:function(t,e){if(/^\d{3}\s\d{3}\s\d{3}$/.test(t.val()))return!0;throw a.PHONE},postcode:function(t,e){if(/^\d{2}-\d{3}$/.test(t.val()))return!0;throw a.POSTCODE},username:function(t,e){if(/^.{6,}$/.test(t.val()))return!0;throw a.USERNAME},password:function(t,e){if(/^.{8,}$/.test(t.val()))return!0;throw a.PASSWORD},password_repeat:function(t,e){if(t.val()==t.closest("form").find('[name="'+t.data("compare")+'"]').val())return!0;throw a.PASSWORDREPEAT}},u={clear:function(t){t.siblings(o(r.FEEDBACK)).remove(),t.closest(o(r.GROUP)).removeClass(r.ERROR)},decorate:function(t,a){t.after(n.ERROR.replace("%ERROR%",a).replace("%CLASS%",r.FEEDBACK)),t.closest(o(r.GROUP)).addClass(r.ERROR)},change:function(){return c.single(t(this))},password:function(){var a=t(this).closest("form").find('[name="'+t(this).data("compare")+'"]');return!a.val()||c.single(a)}},l=function(a){return!!c.all(t(this))||(a.preventDefault(),!1)},c={single:function(t){var a=t[0].tagName,e=(t.data("valid")||"").split(" ");u.clear(t);try{for(var r=0;r<e.length;r++){var n=e[r];"function"==typeof s[n]&&s[n](t,a)}}catch(a){return u.decorate(t,a),!1}return!0},all:function(a){var e=!0;return a.find("[data-valid]").each(function(){c.single(t(this))||(e=!1)}),a.removeClass([r.VALID,r.INVALID].join(" ")).addClass(e?r.VALID:r.INVALID).trigger(e?i.VALID:i.INVALID),e}};t.fn.programaValidate=function(){return this.on("input propertychange",["input","textarea"].join(","),u.change).on("change",['input[type="checkbox"]','input[type="radio"]',"select"].join(","),u.change).on("input propertychange",['input[data-repeat="password"]'].join(","),u.password).on("submit",l)},t.fn.programaIsValid=function(){return c.all(this)}}(jQuery);
