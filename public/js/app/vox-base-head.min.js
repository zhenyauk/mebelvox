...
window.Modernizr = function(e, t, n) {
    ...
    var u, f, d = {},
        ...
        P = function(e, n, r, o) {
            ...
            if (parseInt(r, 10))
                for (; r--;) c = t.createElement("div"), c.id = o ? o[r] : m + (r + 1), l.appendChild(c);
        ...
        A = function(t) {
            ...
            var r;
            return P("@media " + t + " { #" + m + " { position: absolute; } }", function(t) {
        ...
        $ = {}.hasOwnProperty;
    f = i($, "undefined") || i($.call, "undefined") ? function(e, t) {
        ...
        var n;
        return "ontouchstart" in e || e.DocumentTouch && t instanceof DocumentTouch ? n = !0 : P(["@media (", E.join("touch-enabled),("), m, ")", "{#modernizr{top:9px;position:absolute}}"].join(""), function(e) {
            n = 9 === e.offsetTop
        }), n
        ...
        return r((e + "-webkit- ".split(" ").join("gradient(linear,left top,right bottom,from(#9f9),to(white));" + e) + E.join("linear-gradient(left top,#9f9, white);" + e)).slice(0, -e.length)), a(g.backgroundImage, "gradient")
        ...
        var e = !!l("perspective");
        return e && "webkitPerspective" in p.style && P("@media (transform-3d),(-webkit-transform-3d){#modernizr{left:9px;position:absolute;height:3px;}}", function(t, n) {
    ...
    for (var z in k) f(k, z) && (u = z.toLowerCase(), d[u] = k[z](), N.push((d[u] ? "" : "no-") + u));
    return d.input || function() {
        d.input = function(n) {
            for (var r = 0, o = n.length; r < o; r++) j[n[r]] = n[r] in v;
        ...
        function(e, t) {
            ...
            e.html5 = v, s(t)
        }(this, t), d._version = "2.6.2", d._prefixes = E, d._domPrefixes = S, d._cssomPrefixes = x, d.mq = A, d.hasEvent = L, d.testProp = function(e) {
        return c([e])
