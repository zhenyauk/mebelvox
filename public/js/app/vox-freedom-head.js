! function(e, t) {
    ...
    function q(t, n, r) {
        ...
        if (G.msFullscreenElement && e.top !== e && t.getClientRects().length && (o = Math.round(100 * t.getBoundingClientRect()[n])), 0 >= o || null == o) {
            if (o = N(t, n, s), (0 > o || null == o) && (o = t.style[n]), Ye.test(o)) return o;
    ...
    function L(e, t) {
        for (var n, r, i, o = [], s = 0, a = e.length; a > s; s++) r = e[s], r.style && (o[s] = ke.get(r, "olddisplay"), n = r.style.display, t ? (o[s] || "none" !== n || (r.style.display = ""), "" === r.style.display && qe(r) && (o[s] = ke.access(r, "olddisplay", E(r.nodeName)))) : (i = qe(r), "none" === n && i || ke.set(r, "olddisplay", i ? n : oe.css(r, "display"))));
    ...
    function R(e, t, n) {
        ...
        })), 1 === e.nodeType && ("height" in t || "width" in t) && (n.overflow = [p.overflow, p.overflowX, p.overflowY], l = oe.css(e, "display"), "inline" === ("none" === l ? ke.get(e, "olddisplay") || E(e.nodeName) : l) && "none" === oe.css(e, "float") && (p.display = "inline-block")), n.overflow && (p.overflow = "hidden", c.always(function() {
        ...
        if (oe.isEmptyObject(f)) "inline" === ("none" === l ? E(e.nodeName) : l) && (p.display = l);
            ...
            h ? "hidden" in h && (d = h.hidden) : h = ke.access(e, "fxshow", {}), o && (h.hidden = !d), d ? oe(e).show() : c.done(function() {
                oe(e).hide()
            }), c.done(function() {
                var t;
                ke.remove(e, "fxshow");
    ...
    function I(e, t, n) {
        var r, i, o = 0,
            ...
            u = function() {
                if (i) return !1;
                for (var t = rt || O(), n = Math.max(0, l.startTime + l.duration - t), r = n / l.duration || 0, o = 1 - r, s = 0, u = l.tweens.length; u > s; s++) l.tweens[s].run(o);
    ...
    oe.event = {
        ...
        add: function(e, t, n, r, i) {
            ...
            if (v)
                ...
                }), t = (t || "").match(be) || [""], l = t.length; l--;) a = Ie.exec(t[l]) || [], d = g = a[1], h = (a[2] || "").split(".").sort(), d && (f = oe.event.special[d] || {}, d = (i ? f.delegateType : f.bindType) || d, f = oe.event.special[d] || {}, c = oe.extend({
                    type: d,
                    origType: g,
                    data: r,
                    handler: n,
        ...
        fix: function(e) {
            ...
            var t, n, r, i = e.type,
                o = e,
                s = this.fixHooks[i];
            for (s || (this.fixHooks[i] = s = Me.test(i) ? this.mouseHooks : Re.test(i) ? this.keyHooks : {}), r = s.props ? this.props.concat(s.props) : this.props, e = new oe.Event(o), t = r.length; t--;) n = r[t], e[n] = o[n];
    ...
    oe.extend({
        ...
        css: function(e, t, n, r) {
            var i, o, s, a = oe.camelCase(t);
            return t = oe.cssProps[a] || (oe.cssProps[a] = D(a) || a), s = oe.cssHooks[t] || oe.cssHooks[a], s && "get" in s && (i = s.get(e, !0, n)), void 0 === i && (i = N(e, t, r)), "normal" === i && t in et && (i = et[t]), "" === n || n ? (o = parseFloat(i), !0 === n || isFinite(o) ? o || 0 : i) : i
        }
    ...
    oe.fn.extend({
        ...
        toggleClass: function(e, t) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : oe.isFunction(e) ? this.each(function(n) {
                ...
                var t, r, i, o;
                if ("string" === n)
                    for (r = 0, i = oe(this), o = e.match(be) || []; t = o[r++];) i.hasClass(t) ? i.removeClass(t) : i.addClass(t);
                else void 0 !== e && "boolean" !== n || (t = W(this), t && ke.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || !1 === e ? "" : ke.get(this, "__className__") || ""))
            })
        },
        hasClass: function(e) {
            var t, n, r = 0;
    ...
    oe.extend(oe.event, {
        trigger: function(t, n, r, i) {
            ...
            if (s = a = r = r || G, 3 !== r.nodeType && 8 !== r.nodeType && !ht.test(d + oe.event.triggered) && (d.indexOf(".") > -1 && (h = d.split("."), d = h.shift(), h.sort()), l = d.indexOf(":") < 0 && "on" + d, t = t[oe.expando] ? t : new oe.Event(d, "object" == typeof t && t), t.isTrigger = i ? 2 : 3, t.namespace = h.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : oe.makeArray(n, [t]), f = oe.event.special[d] || {}, i || !f.trigger || !1 !== f.trigger.apply(r, n))) {
                ...
                for (o = 0;
                     (s = p[o++]) && !t.isPropagationStopped();) t.type = o > 1 ? u : f.bindType || d, c = (ke.get(s, "events") || {})[t.type] && ke.get(s, "handle"), c && c.apply(s, n), (c = l && s[l]) && c.apply && Ce(s) && (t.result = c.apply(s, n), !1 === t.result && t.preventDefault());
    ...
    oe.ajaxSetup({
        ...
        var i, o, s, a = !1 !== t.jsonp && (Pt.test(t.url) ? "url" : "string" == typeof t.data && 0 === (t.contentType || "").indexOf("application/x-www-form-urlencoded") && Pt.test(t.data) && "data");
        return a || "jsonp" === t.dataTypes[0] ? (i = t.jsonpCallback = oe.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, a ? t[a] = t[a].replace(Pt, "$1" + i) : !1 !== t.jsonp && (t.url += (mt.test(t.url) ? "&" : "?") + t.jsonp + "=" + i), t.converters["script json"] = function() {
...
! function(e) {
    ...
    function t(n, o) {
        ...
        i.element = n, i.el = e(n), i.suggestions = [], i.badQueries = [], i.selectedIndex = -1, i.currentValue = i.element.value, i.intervalId = 0, i.cachedResponse = {}, i.onChangeInterval = null, i.onChange = null, i.isLocal = !1, i.suggestionsContainer = null, i.noSuggestionsContainer = null, i.options = e.extend({}, a, o), i.classes = {
    ...
    t.utils = n, e.Autocomplete = t, t.formatResult = function(e, t) {
        ...
        initialize: function() {
            ...
            o.element.setAttribute("autocomplete", "off"), o.killerFn = function(t) {
                e(t.target).closest("." + o.options.containerClass).length || (o.killSuggestions(), o.disableKillerFn())
            }, o.noSuggestionsContainer = e('<div class="autocomplete-no-suggestion"></div>').html(this.options.noSuggestionNotice).get(0), o.suggestionsContainer = t.utils.createNode(a.containerClass), n = e(o.suggestionsContainer), n.appendTo(a.appendTo), "auto" !== a.width && n.css("width", a.width), n.on("mouseover.autocomplete", s, function() {
                o.activate(e(this).data("index"))
            }), n.on("mouseout.autocomplete", function() {
                o.selectedIndex = -1, n.children("." + i).removeClass(i)
            }), n.on("click.autocomplete", s, function() {
                return o.select(e(this).data("index")), !1
        ...
        killSuggestions: function() {
            ...
            e.stopKillSuggestions(), e.intervalId = window.setInterval(function() {
                e.visible && (e.options.preserveInput || e.el.val(e.currentValue), e.hide()), e.stopKillSuggestions()
            }, 50)
        },
        ...
        onValueChange: function() {
            var t = this,
                ...
                o = t.el.val(),
                s = t.getQuery(o);
            return t.selection && t.currentValue !== s && (t.selection = null, (n.onInvalidateSelection || e.noop).call(t.element)), clearInterval(t.onChangeInterval), t.currentValue = o, t.selectedIndex = -1, n.triggerSelectOnValidInput && t.isExactMatch(s) ? void t.select(0) : void(s.length < n.minChars ? t.hide() : t.getSuggestions(s))
        },
        ...
        getSuggestions: function(t) {
            ...
            if (l.params[l.paramName] = t, o = l.ignoreParams ? null : l.params, !1 !== l.onSearchStart.call(a.element, l.params)) {
                ...
                a.isLocal ? n = a.getSuggestionsLocal(t) : (e.isFunction(r) && (r = r.call(a.element, t)), s = r + "?" + e.param(o || {}), n = a.cachedResponse[s]), n && e.isArray(n.suggestions) ? (a.suggestions = n.suggestions, a.suggest(), l.onSearchComplete.call(a.element, t, n.suggestions)) : a.isBadQuery(t) ? l.onSearchComplete.call(a.element, t, []) : (a.abortAjax(), i = {
                    url: r,
                    data: o,
                    type: l.type,
                    dataType: l.dataType
                    ...
                    var n;
                    a.currentRequest = null, n = l.transformResult(e, t), a.processResponse(n, t, s), l.onSearchComplete.call(a.element, t, n.suggestions)
                }).fail(function(e, n, o) {
        ...
        suggest: function() {
            ...
            return o.triggerSelectOnValidInput && n.isExactMatch(a) ? void n.select(0) : (e.each(n.suggestions, function(e, t) {
                s && (d += p(t, 0)), d += '<div class="' + l + '" data-index="' + e + '">' + i(t, a, e) + "</div>"
            }), this.adjustContainerWidth(), c.detach(), u.html(d), e.isFunction(g) && g.call(n.element, u, n.suggestions), n.fixPosition(), u.show(), o.autoSelectFirst && (n.selectedIndex = 0, u.scrollTop(0), u.children("." + l).first().addClass(r)), n.visible = !0, void n.findBestHint())
        },
        ...
        adjustContainerWidth: function() {
            ...
            "auto" === o.width && (t = n.el.outerWidth(), s.css("width", t > 0 ? t : 300))
        },
        ...
        adjustScroll: function(t) {
            var n = this,
                o = n.activate(t);
            if (o) {
                var s, i, a, l = e(o).outerHeight();
                s = o.offsetTop, i = e(n.suggestionsContainer).scrollTop(), a = i + n.options.maxHeight - l, i > s ? e(n.suggestionsContainer).scrollTop(s) : s > a && e(n.suggestionsContainer).scrollTop(s - n.options.maxHeight + l), n.options.preserveInput || n.el.val(n.getValue(n.suggestions[t].value)), n.signalHint(null)
            }
        },
        onSelect: function(t) {
            var n = this,
...
jQuery(document).ready(function(e) {
    e(window).width();
    e.fn.scrollTo = function(t, i, n) {
        "function" == typeof i && 2 == arguments.length && (n = i, i = t);
        var o = e.extend({
            scrollTarget: t,
            offsetTop: 50,
            duration: 200,
        ...
        return this.each(function() {
            var t = e(this),
                i = "number" == typeof o.scrollTarget ? o.scrollTarget : e(o.scrollTarget),
                a = "number" == typeof i ? i : i.offset().top + t.scrollTop() - parseInt(o.offsetTop);
            t.animate({
                scrollTop: a
    ...
    }), e(".mash-list-items").click(function(t) {
        function i(t) {
            e(t).bind("click", function(t) {
                i.preventDefault(), e(this).parent().fadeOut()
            })
        }
        var i = e(t.target);
        if (!i.parents().hasClass("mash-list-items")) {
            var n = e(".mash-menu").find(".mash-list-items");
            n.parent().removeClass("normal"), n.hide(0)
        }
    }), e(".searchicon").click(function(t) {
        e(window).width() < 1024 && e(".mash-menu").find(".mash-list-items").fadeOut();
        e(".dropdown-cart").is(":visible") && e(".dropdown-cart").fadeToggle(), e(".searchbox").slideToggle("fast", function() {
            e("#search").focus()
        }), t.preventDefault()
    }), e(".mash-mobile-button").submit(function() {
        e(".searchbox").slideToggle("fast")
    }), e(function() {
        e(".search-autocomplete").each(function() {
            var t = e(this).closest(".autocompletebox"),
                i = e(this).data("source");
            e(this).devbridgeAutocomplete({
                serviceUrl: i,
                groupBy: "type",
                paramName: "s",
                noCache: !0,
                ...
                if (13 == t.keyCode && e(this).data("target") && e(this).val().length > 2) return window.location = e(this).data("target") + "?s=" + e(this).val(), t.preventDefault(), !1
            })
        })
    }), e(function() {
        var t = e(".cat-list-container-custom"),
            i = t.find(".cat-list-menu-custom"),
            n = t.find(".cat-list-highlight-custom"),
            o = function(e) {
                if (i.length > 0) {
                    var t = e.position(),
                        o = i.position(),
                        a = parseInt(i.css("margin-top").replace("px", ""));
                    menuMarginLeft = parseInt(i.css("margin-left").replace("px", "")), n.css({
                        left: t.left + o.left + menuMarginLeft,
                        top: t.top + o.top + a,
                        width: e.outerWidth(),
            ...
            r = function() {
                i.length > 0 && o(i.find(".active"))
            };
        t.length && i.length && n.length && (i.on("click", "li a", a), o(i.find(".active")), e(window).on("resize", r), setTimeout(function() {
            o(i.find(".active"))
        }, 500), setTimeout(function() {
            o(i.find(".active"))
        }, 750), e(document).on("scroll", window, function() {
            var e = window.innerWidth;
            e > 1024 && e < 1281 && setTimeout(function() {
                var e = document.querySelector("nav");
                classie.has(e, "smaller") ? n.css({
                    top: 500
                }) : n.css({
                    top: 604
                })
