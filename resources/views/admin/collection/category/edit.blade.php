...
@section('content')
    <div class="content-wrapper">
		...
		<section class="content-header">
			<h1>
				Редагування категорію колекції
			</h1>
			<ol class="breadcrumb">
				...
				<li class="active">Редагування категорію</li>
			</ol>
		</section>
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					<div class="box box-primary">
						...
						<form id="main" class="form-horizontal"  action="/admin_panel/collection/category/{{$category->id}}/update" method="post" enctype="multipart/form-data" novalidate>
							{{ csrf_field() }}
								...
								<div class="tab-content">
									<div id="ru" class="tab-pane fade in active">
										...
										<div class="form-group{{ $errors->has('name_ru') ? ' has-error' : '' }}">
											...
											<div class="col-sm-5">
												{{ Form::text('name', $category->name_ru, ['class' => 'form-control', 'placeholder' => 'Название', 'name' => 'name_ru', 'id' => 'name_ru' ,]) }}
											</div>
										</div>
									...
									<div id="ua" class="tab-pane fade">
										...
										<div class="form-group{{ $errors->has('name_ua') ? ' has-error' : '' }}">
											...
											<div class="col-sm-5">
												{{ Form::text('name', $category->name_ua, ['class' => 'form-control', 'placeholder' => 'Назва', 'name' => 'name_ua', 'id' => 'name']) }}
											</div>
										</div>
