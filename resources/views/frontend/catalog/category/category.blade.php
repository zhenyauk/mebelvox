            ...
            <div class="col-md-12 collectAllContener bordertop">
                ...
                <div class="furniture-type-menu maxwidth cat-list-container-custom">
                    <ul class="cat-list-menu-custom">
                        <li class="filter active" data-filter=".cat-0" data-filter-string="meble-do-wszystkie-pokoje"><a href="javascript:void(0);">Всі</a></li>
                        <li class="filter" data-filter=".cat-1" data-filter-string="meble-do-sypialni"><a href="javascript:void(0);">Спальня</a></li>
                        <li class="filter" data-filter=".cat-3" data-filter-string="meble-do-biura"><a href="javascript:void(0);">Офіс</a></li>
                        <li class="filter" data-filter=".cat-4" data-filter-string="meble-do-jadalni"><a href="javascript:void(0);">Їдальня</a></li>
                        <li class="filter" data-filter=".cat-2" data-filter-string="meble-do-pokoju-dziennego"><a href="javascript:void(0);">Вітальня</a></li>
                        <li class="filter" data-filter=".cat-5" data-filter-string="meble-do-pokoju-mlodziezowego"><a href="javascript:void(0);">Для молодих людей</a></li>
                        <li class="filter" data-filter=".cat-8" data-filter-string="meble-do-pokoju-dzieciecego"><a href="javascript:void(0);">Dla dzieci</a></li>
                        <li class="filter" data-filter=".cat-11" data-filter-string="meble-do-kawalerki"><a href="javascript:void(0);">Kawalerka</a></li>
                        <li class="filter" data-filter=".cat-10" data-filter-string="meble-do-przedpokoju"><a href="javascript:void(0);">Przedpokój</a></li>
                    </ul>
